...
#     p,f,user = ('com.wunding.wdxuexi/3.2.0-wdxuexi-release-1501271726.apk', '/home/ray/develop/working/mlplayer4.0/branch/enterprise/android-padTmp/bin/mlplayer_ulp-release-unsigned.apk', 'bh')
    if [p,f,user].count("") >= 1:
        ...
        try:
            ...
            print(files)
            print("")
            rep = requests.post("http://192.168.0.33/publish/apksign/", files=files)
